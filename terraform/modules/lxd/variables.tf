...
# The name of the LXD provider. This can be a descriptive name for the LXD endpoint.
...
# The scheme used for the LXD connection. This could be, for example, 'http' or 'https'.
...
# The address or URL of the LXD server. This includes the hostname or IP address and, if applicable, the port number.
